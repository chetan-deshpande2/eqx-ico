...
export const buyToken = async (tokenAmount, referrer, tokenName, account) => {
    ...
    // console.log(glimit);
    // var gasLimitHex = web3.toHex(glimit);
    ...
    let res = await contract.methods.buyTokens(referrer, tokenAmount, contracts[tokenName].type).send({ from: account, value: value,gasLimit:"285983", gasPrice: '20000000000' })
